...
/-- Completeness out of reflexivity, for any `Bool`-valued comparison. It lives here
    because this is the highest module the `Data`, `Const`, `Term` and `CekValue`
    comparisons can all see. -/
